...
import pl.skyterix.sadsky.user.request.UserLoginRequest;
...
class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) {
        ...
        pl.skyterix.sadsky.user.domain.User user = applicationContext.getBean(UserRepository.class).findUserByUserId(UUID.fromString(userId)).orElseThrow();
